...
import { Participant } from 'src/0005-vacancies/0005-participants/participant.model';
import { CreateMessageDto } from './0011-messages/dto/create-message.dto';
import { CreateUploadDto } from './0011-messages/dto/create-upload.dto';
import { Message } from './0011-messages/message.model';
import { MessageService } from './0011-messages/message.service';
import { CreateParticipantDto } from './0011-participants/dto/create-participant.dto';
...
export class NotificationController {
  ...
  @ApiOperation({ summary: 'Получение участников' })
  @ApiResponse({ status: 200, type: Participant })
  @Get('/:chats_id/participant')
  async getParticipants(@Param('chats_id', ParseIntPipe) chats_id: number) {
    const data = await this.participantService.getParticipants(chats_id);
    return data;
  }
