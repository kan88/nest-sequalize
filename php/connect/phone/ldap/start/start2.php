...
try {
  ...
  $UFNSCA = array("UNS00", "UNS2400", "UNS2700", "UNS4200", "UNS5001", "UNS5002", "UNS5200", "UNS5201", "UNS7000", "UNS7701", "UNS7800");

  for ($k = 0; $k < count($UFNSCA); $k++) {
    echo "<h3>LDAP query test</h3>";
    echo "Connecting ...";
    $ds = ldap_connect("ldap://n5201-dc03.dpc.tax.nalog.ru");
    $user = 'n7700_svc_ldap';
    $pass = '1Gfhjkmgfhjkm';
    ...
    if ($ds) {
      ...
      $dn = "OU={$UFNSCA[$k]},DC=dpc,DC=tax,DC=nalog,DC=ru";
